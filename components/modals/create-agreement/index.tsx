...
export const CreateAgreement = () => {
  const { isCreateAgreementOpen, toggleCreateAgreement } = useModal();

  useEffect(() => {
    if (isCreateAgreementOpen) document.body.style.overflow = "hidden";
  ...
  return (
    <Transition appear show={isCreateAgreementOpen} as={Fragment}>
      <Dialog
        as="div"
        className="relative z-10"
        onClose={toggleCreateAgreement}
      >
        <Transition.Child
          as={Fragment}
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-[38rem] transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all min-h-[18.75rem]  ">
